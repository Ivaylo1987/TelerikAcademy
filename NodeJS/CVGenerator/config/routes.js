...
module.exports = function(app) {
    ...
    app.get('/cv/create', auth.isAuthenticated, controllers.cv.getCreateCV);
    app.post('/cv/create', auth.isAuthenticated, controllers.cv.postCreateCV);
    app.get('/cv', auth.isAuthenticated, controllers.cv.getCVMain);
